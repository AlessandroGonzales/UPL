    ...
    <section id="inicio" className="relative w-full flex flex-col md:min-h-screen md:items-center md:justify-center overflow-hidden bg-primaryDark">
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6 py-8 md:py-0 -mt-20 md:mt-0 max-w-4xl">
        ...
        <div className="mt-8 flex flex-col md:flex-row gap-4 w-full md:w-auto animate-fade-in">
          <a
            href="#sobre-nosotros"
            className="bg-gold hover:bg-yellow-600 text-primaryDark font-bold py-4 px-10 rounded-full transition-all transform active:scale-95 shadow-lg text-center flex items-center justify-center"
          >
            Quienes somos
          </a>

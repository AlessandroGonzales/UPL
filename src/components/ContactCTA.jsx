...
export default function ContactCTA() {
  ...
  return (
    <section className="bg-primaryDark py-24 px-6 border-t border-white/5 relative overflow-hidden">
        ...
        >
          ...
          <div className="flex flex-col items-center gap-4">
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="group flex items-center gap-4 bg-white text-primaryDark font-black py-5 px-12 rounded-full shadow-[0_20px_40px_rgba(0,0,0,0.3)] transition-all uppercase tracking-widest text-sm"
            >
              Hablemos ahora
            ...
            <p className="text-gray-500 text-xs uppercase tracking-[3px] mt-4">
              Respondemos cada mensaje inmediatamente.
            </p>
          </div>
        </motion.div>
      </div>
